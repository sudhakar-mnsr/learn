...
func main() {
   ...
   // reads the incoming request and send response
   
   // read incoming requests.
   // since we are using sessionless proto, each request can 
   // potentially go to a different client. Therefore, the 
   // ReadFromXXX operation returns the remote address (raddr)
